...
:INPUTS
CLS
ECHO.-------------------------------- & ECHO. Pi-hole for Windows v.20220108 & ECHO.-------------------------------- & ECHO.
...
ECHO %PRGF:~0,2% ^& CD "%PRGF%"                                                   >> "%PRGF%\Pi-hole Uninstall.cmd"
ECHO WSLCONFIG /T Pi-hole ^> NUL 2^>^&1                                           >> "%PRGF%\Pi-hole Uninstall.cmd"
...
ECHO @%GO% "cp /.ss /bin/ss ; apt-get -qq remove dhcpcd5 > /dev/null 2>&1 ; apt-get clean"                                              >> "%PRGF%\Pi-hole Launcher.cmd"
